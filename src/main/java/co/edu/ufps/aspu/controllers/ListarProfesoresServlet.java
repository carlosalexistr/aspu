 ...
 * @author Carlos
 */
@WebServlet(name = "ListarProfesoresServlet", urlPatterns = { "/profesores" })
public class ListarProfesoresServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/view/profesores.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		List<Usuario> listado = profesorService.filtrarProfesor(palabra);
		request.setAttribute("profesores", listado);
		RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/view/profesores.jsp");
		rd.forward(request, response);
	}
